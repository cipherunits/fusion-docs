...
Current published version of the framework packages: **1.2.6** (see the [fusion-framework](https://github.com/cipherunits/fusion-framework) repository).
...
2. [Workspace and crates](./workspace) — where core vs bindings live
3. [Project structure](./project-structure) — what `fusion init` creates
4. **[Fusion Tool](../../cli/v1)** — scaffold apps and environments
5. Language getting started: [Python](../../python/v1/getting-started) · [TypeScript](../../typescript/v1/getting-started) · [C#](../../csharp/v1/getting-started)
6. [Application route modules](./application-modules)
7. [Reusable packages](./packages) · [CLI Modules](../../cli/v1/modules)
8. [Application lifecycle](./lifecycle) · [Settings and configuration](./settings) · [Request lifecycle](./request-lifecycle)
9. [Best practices](./best-practices) · [Anti-patterns](./anti-patterns)
