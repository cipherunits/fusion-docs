...
Default environment values from the CLI scaffold:

| File | Port | Host | Debug | Swagger |
| --- | --- | --- | --- | --- |
| `fusion.dev.json` | `8080` | `127.0.0.1` | `true` | on |
| `fusion.stage.json` | `8081` | from `HOST` env | `false` | off |
| `fusion.prod.json` | `9090` | from `HOST` env | `false` | off |
